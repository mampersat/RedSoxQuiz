...
exports.handler = function (event, context) {
    try {
     ...
     if (event.session.application.applicationId !== "amzn1.ask.skill.c296d12d-e29d-462e-8b49-ef7262ad17e9") {
...
function getWelcomeResponse(callback) {
    ...
    var sessionAttributes = {},
        ...
        speechOutput = "I will ask you " + GAME_LENGTH.toString()
            + " questions, try to get as many right as you can. Red Sox lineup data is from August sixth. Just say the answer. Let's begin. ",
    ...
    if (!gameInProgress) {
        ...
        if (currentQuestionIndex == GAME_LENGTH - 1) {
            ...
            speechOutput += speechOutputAnalysis + "You got " + currentScore.toString() + " out of "
                + GAME_LENGTH.toString() + " questions correct. I love that dirty water.";
            callback(session.attributes,
